    ...
    return (
      <div className="flex items-center gap-2">
        ...
        <a
          ...
          className="rounded-lg bg-gradient-to-r from-accent to-accent-dim px-4 py-2 text-xs font-bold uppercase tracking-wider text-bg shadow-[0_4px_16px_rgba(56,189,248,0.3)] transition-transform hover:scale-[1.02]"
        >
          Download
        </a>
      </div>
