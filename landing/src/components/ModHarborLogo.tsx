...
export default function ModHarborLogo({
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="mh-sky-landing" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#7dd3fc" />
          <stop offset="100%" stopColor="#38bdf8" />
        </linearGradient>
        <linearGradient id="mh-sea-landing" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor="#0ea5e9" />
          <stop offset="100%" stopColor="#0284c7" />
        </linearGradient>
      </defs>
      <rect width="64" height="64" rx="14" fill="url(#mh-sky-landing)" />
      <path
        d="M0 46 C16 40 24 50 40 44 C52 40 58 46 64 42 V64 H0 Z"
        fill="url(#mh-sea-landing)"
        opacity="0.9"
      />
      <path
      ...
      <path d="M32 12 L38 8 L38 16 Z" fill="#fef9c3" opacity="0.45" />
