...
export default function WaveDivider({
  ...
  const fillA = variant === 'accent' ? 'var(--color-launcher-accent)' : 'var(--color-launcher-elevated)'
  const fillB = variant === 'accent' ? 'var(--color-launcher-accent-dim)' : 'var(--color-launcher-border)'
